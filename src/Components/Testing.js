...
import './App.css'; // Ensure you have the required CSS or Tailwind setup
...
function Testing() {
  return (
    ...
    //         <li>Access top-tier talent from around the globe</li>
    //         <li>Accelerate your hiring timeline and secure the best candidates faster</li>
    //       </ul>
