...
const Homepage = () => {
  ...
  const { loggedInCompany } = useCompanyContext()
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tl from-red-50 to-red-100 flex flex-col items-center">
      <Navbar />

      <main className="container w-full font-serif z-0 mx-auto">
        <div className='flex-1 w-full mt-16 bg-white rounded-2xl text-center p-6 shadow-lg' data-aos="zoom-in-down" data-aos-delay="200">
          ...
          {loggedInCompany ? (
            <Link to="/candidate-search">
              <button className="bg-red-600 text-lg text-white md:px-6 sm:px-5 px-4 md:py-3 sm:py-2 py-1 drop-shadow-lg hover:ring-1 hover:scale-105 transition-all duration-500 hover:bg-transparent hover:text-red-800 hover:ring-red-500 rounded-lg">
                Start Hiring
              </button>
            </Link>
          ) : (
            <button
              ...
              className="bg-red-600 text-lg text-white md:px-6 sm:px-5 px-4 md:py-3 sm:py-2 py-1 drop-shadow-lg hover:ring-1 hover:scale-105 transition-all duration-500 hover:bg-transparent hover:text-red-800 hover:ring-red-500 rounded-lg"
            >
              Start Hiring
            </button>
          )}       </div>
